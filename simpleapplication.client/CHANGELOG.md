...
- Create Angular project with ng: `ng new simpleapplication.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`simpleapplication.client.esproj`).
